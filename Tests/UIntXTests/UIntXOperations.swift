...
final class UIntXOperations: XCTestCase {
    ...
    func testBinaryNot() {
        ...
        XCTAssertEqual(
            ~UIntX8(littleEndianArray: [0b01010101, 0b00001111, 0b11110000] as [UInt8]),
    ...
    func testQuotientAndRemainder() {
        ...
        let largeValue = UIntX8(littleEndianArray: [UInt.max, 123])
    ...
    func testAddingWithOverflow() {
        ...
        XCTAssertEqual(
            ...
            UIntX8(littleEndianArray: [UInt.max - 1, 1])
        )
    ...
    func testSubtractingWithOverflow() {
        ...
        XCTAssertEqual(
            UIntX8(littleEndianArray: [UInt.max, 567_890])
                .subtractingReportingOverflow(UIntX8(UInt.max))
                .partialValue,
            UIntX8(littleEndianArray: [0, 567_890] as [UInt])
        )

        XCTAssertEqual(
            UIntX8(littleEndianArray: [UInt.max, 567_890]).subtractingReportingOverflow(UIntX8(UInt.max)).overflow,
            false
        )

        XCTAssertEqual(
            UIntX8(littleEndianArray: [UInt.max, 567_890])
                .subtractingReportingOverflow(UIntX8(littleEndianArray: [UInt.max, 567_890]))
                .partialValue,
            0
        )
        ...
        XCTAssertEqual(
            UIntX8(littleEndianArray: [UInt.max, 567_890])
                .subtractingReportingOverflow(UIntX8(littleEndianArray: [UInt.max, 567_891]))
                .overflow,
            true
        )
