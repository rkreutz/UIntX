...
final class UIntXDescription: XCTestCase {
    ...
    func testDescription() {
        ...
        XCTAssertEqual(UIntX8(ascendingArray: [0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1] as [UInt8]).description, "0x010101010101010101")
        XCTAssertEqual(UIntX16(ascendingArray: [0x1, 0x1, 0x1, 0x1, 0x1] as [UInt16]).description, "0x00010001000100010001")
        XCTAssertEqual(UIntX32(ascendingArray: [0x1, 0x1, 0x1] as [UInt32]).description, "0x000000010000000100000001")
